...
public class Card implements Comparable<Card> {
     ...
     * @param suit Number of a suit if format:\n
    ...
    /**
     * Set value of suit to particular number @param n
    ...
    /**
     * Set value of face value to particular number @param n
     ...
     * @param card Card that we want compare to
